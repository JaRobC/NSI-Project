...
###########################################################
    ...
    def quest_screen(self):                                                                
        ...
        while running:   
            ...
            button_theend = pygame.Rect(550, 170, 150, 75)
            ...
            if button_prec.collidepoint((mx, my)):
                if click:
                    if self.hud.page == 1:
                        ...
                        self.hud.page -= 1
            if self.hud.page == 6:
                if button_theend.collidepoint((mx, my)):
                    if click:
                        print("ok")
            ...
            if self.hud.page == 6:
                pygame.draw.rect(self.screen, (255, 255, 255), button_theend)                       #
...
###########################################################
    ...
    def isQuestValid(self):
        if self.hud.questbase_isDo == True and self.isQuest1 == False:
            self.hud.anotherPopup += 1
            self.money += 10
            self.hud.questbase_cond = True
            self.isQuest1 = True
            if self.hud.anotherPopup < 2:
                self.hud.quest1_first = True
                self.hud.popup_quest(self.hud.questbase_cond, self.screen, self.hud.popup_img, self.hud.questbase_title, self.hud.popup_questbase_desc)
            elif self.hud.anotherPopup >= 2 and self.hud.quest1_first == False:
                self.hud.popup_quest2(self.hud.questbase_cond, self.screen, self.hud.popup_img, self.hud.questbase_title, self.hud.popup_questbase_desc)
        if self.hud.quest2_isDo == True and self.isQuest2 == False:
            self.hud.anotherPopup += 1
            self.money += 10
            self.hud.quest2_cond = True
            if self.hud.anotherPopup < 2:
                self.hud.quest2_first = True
                self.hud.popup_quest(self.hud.quest2_cond, self.screen, self.hud.popup_img, self.hud.quest2_title, self.hud.popup_quest2_desc)
                print("ntm")
                self.isQuest2 = True
                pygame.display.flip()
            elif self.hud.anotherPopup >= 2 and self.hud.quest2_first == False:
                self.hud.popup_quest2(self.hud.quest2_cond, self.screen, self.hud.popup_img, self.hud.quest2_title, self.hud.popup_quest2_desc)
                self.isQuest2 = True
                pygame.display.flip()
        if self.hud.quest3_isDo == True and self.isQuest3 == False:
            ...
            self.isQuest3 = True
            if self.hud.anotherPopup < 2:
                self.hud.quest3_first = True
                self.hud.popup_quest(self.hud.quest3_cond, self.screen, self.hud.popup_img, self.hud.quest3_title, self.hud.popup_quest3_desc)
            elif self.hud.anotherPopup >= 2 and self.hud.quest3_first == False:
                self.hud.popup_quest2(self.hud.quest3_cond, self.screen, self.hud.popup_img, self.hud.quest3_title, self.hud.popup_quest3_desc)
        if self.hud.quest4_isDo == True and self.isQuest4 == False:
            ...
            self.isQuest4 = True
            if self.hud.anotherPopup < 2:
                self.hud.quest4_first = True
                self.hud.popup_quest(self.hud.quest4_cond, self.screen, self.hud.popup_img, self.hud.quest4_title, self.hud.popup_quest4_desc)
            elif self.hud.anotherPopup >= 2 and self.hud.quest4_first == False:
                self.hud.popup_quest2(self.hud.quest4_cond, self.screen, self.hud.popup_img, self.hud.quest4_title, self.hud.popup_quest4_desc)
        if self.hud.quest5_isDo == True and self.isQuest5 == False:
            ...
            self.isQuest5 = True
            if self.hud.anotherPopup < 2:
                self.hud.quest5_first = True
                self.hud.popup_quest(self.hud.quest5_cond, self.screen, self.hud.popup_img, self.hud.quest5_title, self.hud.popup_quest5_desc)
            elif self.hud.anotherPopup >= 2 and self.hud.quest5_first == False:
                self.hud.popup_quest2(self.hud.quest5_cond, self.screen, self.hud.popup_img, self.hud.quest5_title, self.hud.popup_quest5_desc)
