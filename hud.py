...
class HUD:
    ...
    def render(self, screen, color):
        ...
        if self.questbase_cond == True:
            screen.blit(self.popup_img, (550, 20))

            quest_title = self.font_warning.render(self.questbase_title, False, (0, 0, 0))
            screen.blit(quest_title, (570, 25))

            quest_desc = self.font_desc_popup.render(self.popup_questbase_desc, False, (0, 0, 0))
            screen.blit(quest_desc, (570, 55))

        elif self.quest2_cond == True:
            screen.blit(self.popup_img, (550, 20))

            quest_title = self.font_warning.render(self.quest2_title, False, (0, 0, 0))
            screen.blit(quest_title, (570, 25))

            quest_desc = self.font_desc_popup.render(self.popup_quest2_desc, False, (0, 0, 0))
            screen.blit(quest_desc, (570, 55))
            
        elif self.quest3_cond == True:
            screen.blit(self.popup_img, (550, 20))

            quest_title = self.font_warning.render(self.quest3_title, False, (0, 0, 0))
            screen.blit(quest_title, (570, 25))

            quest_desc = self.font_desc_popup.render(self.popup_quest3_desc, False, (0, 0, 0))
            screen.blit(quest_desc, (570, 55))

        elif self.quest4_cond == True:
            screen.blit(self.popup_img, (550, 20))

            quest_title = self.font_warning.render(self.quest4_title, False, (0, 0, 0))
            screen.blit(quest_title, (570, 25))

            quest_desc = self.font_desc_popup.render(self.popup_quest4_desc, False, (0, 0, 0))
            screen.blit(quest_desc, (570, 55))
            
        elif self.quest5_cond == True:
            screen.blit(self.popup_img, (550, 20))

            quest_title = self.font_warning.render(self.quest5_title, False, (0, 0, 0))
            screen.blit(quest_title, (570, 25))

            quest_desc = self.font_desc_popup.render(self.popup_quest5_desc, False, (0, 0, 0))
            screen.blit(quest_desc, (570, 55))
